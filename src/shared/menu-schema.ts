    ...
    submenu: [
      {
        ...
        submenu: [
          ...
          { id: 'new-sep-vpw', type: 'separator' },
          {
            id: 'new-vpw-basic-example',
            label: 'VPW Basic Example Table',
            action: 'new-table',
            actionArg: 'vpwBasicExampleTable.vpx',
          },
          {
            id: 'new-vpw-example',
            label: 'VPW Example Table',
            action: 'new-table',
            actionArg: 'vpwExampleTable.vpx',
          },
          {
            id: 'new-vpw-rom-example',
            label: 'VPW ROM Example Table',
            action: 'new-table',
            actionArg: 'vpwRomExampleTable.vpx',
          },
          { id: 'new-sep-glf', type: 'separator' },
          {
            id: 'new-glf-starter',
