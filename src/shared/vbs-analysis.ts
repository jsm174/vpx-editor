...
/**
 * Lint a VBS script for common pitfalls. `coreSymbols` holds the identifiers declared at the top
 * level of the loaded system scripts (core.vbs and friends); when empty, the redefinition check is skipped.
 */
