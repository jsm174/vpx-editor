...
import type { Settings, WindowBounds } from './settings/settings-manager.js';
...
interface CollectionPromptInitData {
  mode: string;
  currentName: string;
  defaultValue: string;
  existingNames: string[];
...
export interface WindowFactory {
  ...
  openPromptWindow(config: PromptConfig): Promise<string | null>;
  openInfoWindow(config: InfoConfig): Promise<void>;
  openConfirmWindow(config: ConfirmConfig): Promise<ConfirmResult>;
  openWorkFolderWindow(config: WorkFolderConfig): Promise<string>;
  ...
  resolveWorkFolder(result: string): void;
  ...
  getRenamePromptData(): { ctx: WindowContext; mode: string; currentName: string; existingNames: string[] } | null;
...
let confirmResolve: ((value: ConfirmResult) => void) | null = null;
let workFolderWindow: BrowserWindow | null = null;
let workFolderResolve: ((value: string) => void) | null = null;
...
let renamePromptData: { ctx: WindowContext; mode: string; currentName: string; existingNames: string[] } | null = null;
...
export function createWindowFactory(deps: WindowFactoryDeps): WindowFactory {
  ...
  function showAboutDialog(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/dialogs/about-window.html';
  ...
  function openImageManagerWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/image-manager.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openMaterialManagerWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/material-manager.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openSoundManagerWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/sound-manager.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  async function openTableInfoWindow(): Promise<void> {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/settings/table-info-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  async function openDimensionsManagerWindow(): Promise<void> {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/dimensions-manager-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openCollectionManagerWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/collection-manager-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openRenderProbeManagerWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/managers/render-probe-manager.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openScriptEditorWindow(ctx?: WindowContext | null): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/script-editor/script-editor.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openSettingsWindow(): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/settings/settings-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openTransformWindow(type: string, data: TransformData, ctx: WindowContext): void {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/settings/transform-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  function openPromptWindow(config: PromptConfig): Promise<string | null> {
    return new Promise(resolve => {
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/dialogs/prompt-window.html';
        url.searchParams.set('theme', themeQuery.theme);
        promptWindow.loadURL(url.toString());
      } else {
  ...
  function openInfoWindow(config: InfoConfig): Promise<void> {
    return new Promise(resolve => {
      if (infoWindow) {
        infoWindow.focus();
        return;
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/dialogs/info-window.html';
        url.searchParams.set('theme', themeQuery.theme);
        infoWindow.loadURL(url.toString());
      } else {
  ...
  function openConfirmWindow(config: ConfirmConfig): Promise<ConfirmResult> {
    return new Promise(resolve => {
      if (confirmWindow) {
        confirmWindow.focus();
        return;
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/dialogs/confirm-window.html';
        url.searchParams.set('theme', themeQuery.theme);
        confirmWindow.loadURL(url.toString());
      } else {
  ...
  function openWorkFolderWindow(config: WorkFolderConfig): Promise<string> {
    return new Promise(resolve => {
      if (workFolderWindow) {
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/dialogs/work-folder-window.html';
        url.searchParams.set('theme', themeQuery.theme);
        workFolderWindow.loadURL(url.toString());
      } else {
  ...
  function openMeshImportWindow(ctx: WindowContext): Promise<MeshImportResult | null> {
    return new Promise(resolve => {
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/dialogs/mesh-import-window.html';
        url.searchParams.set('theme', themeQuery.theme);
  ...
  function openDrawingOrderWindow(
    ...
    return new Promise(resolve => {
      ...
      if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
        const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
        url.pathname = '/src/windows/settings/drawing-order-window.html';
        url.searchParams.set('theme', themeQuery.theme);
  ...
  async function showSearchSelect(): Promise<void> {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/search-select/search-select.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  async function openCollectionEditorWindow(ctx: WindowContext, collectionName: string): Promise<void> {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/dialogs/collection-editor-window.html';
      url.searchParams.set('theme', themeQuery.theme);
  ...
  async function openCollectionPromptWindow(ctx: WindowContext, mode: string, currentName?: string): Promise<void> {
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/dialogs/collection-prompt-window.html';
      url.searchParams.set('theme', themeQuery.theme);
    ...
    const initData: CollectionPromptInitData = {
      mode,
    ...
    collectionPromptWindow.webContents.on('did-finish-load', () => {
      collectionPromptWindow!.webContents.send('init-collection-prompt', initData);
  ...
  async function openRenamePromptWindow(
    ...
    const title = mode === 'table' ? 'Rename Table' : 'Rename';
    ...
    if (MAIN_WINDOW_VITE_DEV_SERVER_URL) {
      const url = new URL(MAIN_WINDOW_VITE_DEV_SERVER_URL);
      url.pathname = '/src/windows/dialogs/rename-prompt-window.html';
      url.searchParams.set('theme', themeQuery.theme);
