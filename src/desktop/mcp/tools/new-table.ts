...
// The glf template's embedded script predates the CreateGlf* API, so createNewTable regenerates
// its script and collections against the bundled framework (library/glf/starter).
