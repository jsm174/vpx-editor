...
export const MATERIAL_REF_KEYS = [
  'material',
  'rubber_material',
  'ring_material',
  'cap_material',
...
export const IMAGE_REF_KEYS = ['image', 'image_a', 'image_b'];

function collectRefs(data: Record<string, unknown>, keys: string[]): string[] {
...
export function collectMaterialRefs(data: Record<string, unknown>): string[] {
  return collectRefs(data, MATERIAL_REF_KEYS);
}

export function collectImageRefs(data: Record<string, unknown>): string[] {
  return collectRefs(data, IMAGE_REF_KEYS);
}
